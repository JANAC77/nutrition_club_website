    ...
    <section id="contact" style={{ padding: '4rem 0', background: 'var(--brand-primary)', color: 'white' }}>
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <h2 style={{ fontSize: '3.5rem', lineHeight: '1.1', fontWeight: '800', marginBottom: '1rem' }}>Get Your Free Consultation</h2>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            {['100% Free', 'No Obligation', 'Expert Advice'].map((item, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: '600', fontSize: '1rem' }}>
        ...
        <div className="grid-2" style={{ gap: '2rem', alignItems: 'stretch' }}>
          ...
          <div style={{ borderRadius: '20px', overflow: 'hidden', boxShadow: 'var(--shadow-lg)' }}>
            <img src="https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=800&q=80" alt="Fresh Vegetables" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </div>

          <div style={{ background: 'white', padding: '3rem', borderRadius: '20px', boxShadow: 'var(--shadow-lg)', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <form style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <textarea placeholder="Message (Optional)" rows="4" style={{ width: '100%', padding: '1rem', border: '1px solid #e2e8f0', borderRadius: '8px', fontSize: '1rem', outline: 'none', resize: 'vertical', flexGrow: 1 }}></textarea>
